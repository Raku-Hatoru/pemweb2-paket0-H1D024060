...
class UpdateMemberRequest extends FormRequest
{
    ...
    protected function prepareForValidation(): void
    {
        ...
        $this->merge([
            ...
            'member_code' => $memberCode !== '' ? $memberCode : $member->member_code,
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'email' => ['required', 'string', 'email', 'max:150', Rule::unique(User::class, 'email')->ignore($member->user)],
            'password' => ['nullable', 'confirmed', Password::min(8)->letters()->numbers()],
            'member_code' => ['required', 'string', 'max:20', Rule::unique(Member::class, 'member_code')->ignore($member)],
